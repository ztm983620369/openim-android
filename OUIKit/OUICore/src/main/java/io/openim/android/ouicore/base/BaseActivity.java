...
@Deprecated
public class BaseActivity<T extends BaseViewModel, A extends ViewBinding> extends AppCompatActivity implements IView {
    //是否释放资源
    ...
    protected void bindViewDataBinding(A viewDataBinding, boolean lifecycleOwner) {
        ...
        if (lifecycleOwner && view instanceof ViewDataBinding) {
            ((ViewDataBinding) view).setLifecycleOwner(this);
        }
    }
